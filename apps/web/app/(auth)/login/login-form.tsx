        ...
        <FormField id="password" label="Password" required>
          <div className="relative">
            ...
            <input
              ...
              required
              className="h-[33px] w-full rounded-input border border-border bg-surface pl-9 pr-9 text-[12px] text-fg placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent"
              placeholder="••••••••"
            />
            <button
              type="button"
